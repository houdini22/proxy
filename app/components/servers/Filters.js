                                        ...
                                        <FormGroup controlId="formHorizontalEmail" className="form-group-sm">
                                            <Col componentClass={ControlLabel} sm={3} md={4}>
                                                ...
                                                <OverlayTrigger placement="top"
                                                                overlay={<Tooltip id="premium-enable">Option available
                                            ...
                                            <Col sm={9} md={8}>
                                                ...
                                                >
                                                    <option value="all">All</option>
                                                    <option value="fastest" disabled={!premiumEnabled}>Fastest (0 - 3
                                                        seconds)
                                                    </option>
                                                    <option value="fast" disabled={!premiumEnabled}>Fast (3 - 10
                                                        seconds)
                                                    </option>
                                                    <option value="medium" disabled={!premiumEnabled}>Medium (10 - 25
                                                        seconds)
                                                    </option>
                                                    <option value="slow" disabled={!premiumEnabled}>Slow (25+ seconds)
                                                    </option>
                                                </FormControl>
                                            </Col>
                                        </FormGroup>
                                        ...
                                        <FormGroup controlId="formHorizontalEmail" className="form-group-sm">
                                            ...
                                            <Col sm={9} md={8}>
                                                ...
                                                >
                                                    ...
                                                    <option value="fast" disabled={!premiumEnabled}>Fast (10 - 25
                                                        kB/seconds)
                                                    </option>
                                                    <option value="medium" disabled={!premiumEnabled}>Medium (2 - 10
                                                        kB/seconds)
                                                    </option>
                                                    <option value="slow" disabled={!premiumEnabled}>Slow ( > 2
                                                        kB/seconds)
                                                    </option>
                                                </FormControl>
                                            </Col>
                                                    ...
                                                    <option value="all">All</option>
                                                    {
                                                        countries.map((obj, i) => {
                                                            return <option key={i} value={obj.country}
                                                                           disabled={!premiumEnabled}>{obj.country}
                                                                &nbsp;({obj.count})</option>;
                                                        })
                                                    }
                                                </FormControl>
